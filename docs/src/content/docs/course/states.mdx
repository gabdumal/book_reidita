...
3.  Dentro do método `forEach`, obtenha o objeto `resource` a partir da sua chave. Então, calcule o novo valor do recurso e verifique se a troca é possível.
...
4.  Dentro do método `forEach`, caso a troca seja possível, atualize o valor do recurso.
...
5.  Após o método `forEach`, verifique se todas as trocas foram possíveis e, caso positivo, atualize o estado dos recursos.
