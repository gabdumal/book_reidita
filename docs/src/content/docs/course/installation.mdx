...
1. Remover a pasta `src/assets`.
2. Apagar todo o conteúdo do arquivo `src/index.css`.
3. Excluir o arquivo `src/App.css`.
4. Apagar todo o conteúdo do arquivo `src/App.tsx` e adicionar o seguinte código:
...
5. Apagar todo o conteúdo do arquivo `index.html` e adicionar o seguinte código:
...
<Figure
  ...
  images={[
    {
      src: viteClean,
      alt: "Página inicial do Vite após a limpeza, mostrando apenas o título e uma descrição do projeto.",
    },
  ]}
/>
